...
/**
 * The Script Class - Add, edit scripts and cuts to moduls
 * @author     Thorben Auer
...
class Script
{
    ...
    /**
     * Set Cut List for Modul
     *
     * @param string   $sessionHash     Hash of User who wants to set the list
     * @param string   $cutList         List of cuts divided by ','
     * @param int   $modulId         Id of modul to set the list
     *
     * @return array
     */
     ...
     * @param string   $sessionHash     Hash of User who wants to set the list
     * @param int   $modulId         Id of modul to set the list
     * @param array    $pdf              File Object of PDF
     *
     * @return array
     */
