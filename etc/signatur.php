<?php
    ...
    $signatur = ' <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
    ...
    <table style="width: 515px; font-size: 10pt; font-family: Arial, sans-serif;"  cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="font-size: 10pt; font-family: Arial, sans-serif; padding-bottom: 10px; padding-top: 10px; vertical-align:top;" colspan="2" valign="top">	
         <a href="https://mikropi.de" target="_blank" rel="noopener">
          <img alt="Banner" style="width:514px; height:auto; border:0;" src="https://mikropi.de/images/logo_dark.png" width="514" border="0">
         </a>	 </td>
      </tr>
      <tr>
        <td style="font-size: 10pt; color:#2c2c2c; font-family: Arial, sans-serif; padding-top: 10px; vertical-align:top;" colspan="2"  valign="top">      
         <div style="color:#2c2c2c; font-size: 9pt; font-family: Arial, sans-serif; text-align:justify; width:514px;"  align="justify">Der Inhalt dieser E-Mail ist vertraulich und nur für den in der Nachricht angegebenen Empfänger bestimmt. Es ist strengstens untersagt, Teile dieser Nachricht ohne schriftliche Zustimmung des Absenders an Dritte weiterzugeben. Wenn Sie diese Nachricht versehentlich erhalten haben, antworten Sie bitte auf diese Nachricht und führen Sie die Löschung durch, damit wir sicherstellen können, dass ein solcher Fehler in Zukunft nicht mehr auftritt.</div></td>
      </tr>
      </tbody>
     </table>
    </BODY></HTML>';
